...
function themeConfig($form)
{
    ...
    $form->addInput($qq);
    $wechat = new Typecho_Widget_Helper_Form_Element_Text('wechat', NULL, 'https://blogcdn.loliko.cn/donate/wx.png', _t('微信二维码'),_t('显示在侧边栏'));
    $form->addInput($wechat);
    $github = new Typecho_Widget_Helper_Form_Element_Text('github', NULL, 'https://github.com', _t('Github'),_t('显示在侧边栏'));
    $form->addInput($github);
    $csdn = new Typecho_Widget_Helper_Form_Element_Text('csdn', NULL, 'https://csdn.com', _t('CSDN'),_t('显示在侧边栏'));
    $form->addInput($csdn);
    $juejin = new Typecho_Widget_Helper_Form_Element_Text('juejin', NULL, 'https://juejin.com', _t('掘金'),_t('显示在侧边栏'));
    $form->addInput($juejin);
    $sifou = new Typecho_Widget_Helper_Form_Element_Text('sifou', NULL, 'https://sifou.com', _t('思否'),_t('显示在侧边栏'));
    $form->addInput($sifou);
    $weibo = new Typecho_Widget_Helper_Form_Element_Text('weibo', NULL, 'https://weibo.com', _t('微博'),_t('显示在侧边栏'));
    $form->addInput($weibo);
    $toutiao = new Typecho_Widget_Helper_Form_Element_Text('toutiao', NULL, 'https://jinritoutiao.com', _t('头条'),_t('显示在侧边栏'));
    $form->addInput($toutiao);
    $zhihu = new Typecho_Widget_Helper_Form_Element_Text('zhihu', NULL, 'https://zhihu.com', _t('知乎'),_t('显示在侧边栏'));
    $form->addInput($zhihu);
    $jianshu = new Typecho_Widget_Helper_Form_Element_Text('jianshu', NULL, 'https://jianshu.com', _t('简书'),_t('显示在侧边栏'));
    $form->addInput($jianshu);
    $douban = new Typecho_Widget_Helper_Form_Element_Text('douban', NULL, 'https://douban.com', _t('豆瓣'),_t('显示在侧边栏'));
    $form->addInput($douban);
    $bilibili = new Typecho_Widget_Helper_Form_Element_Text('bilibili', NULL, 'https://space.bilibili.com', _t('哔哩哔哩'),_t('显示在侧边栏'));
    $form->addInput($bilibili);
    $facebook = new Typecho_Widget_Helper_Form_Element_Text('facebook', NULL, 'https://facebook.com', _t('Facebook'),_t('显示在侧边栏'));
    $form->addInput($facebook);
    $twitter = new Typecho_Widget_Helper_Form_Element_Text('twitter', NULL, 'https://x.com', _t('Twitter'),_t('显示在侧边栏'));
